...
| [0003](0003-offset-pagination-instead-of-keyset.md)              | Offset pagination instead of keyset                      | Every index and board list stays bounded (25/page, 50/column) at a data volume too small for keyset's guarantees to matter                           |
...
| [0007](0007-in-container-scheduler-instead-of-railway-cron.md)   | In-container scheduler instead of a Railway cron service | Runs the daily `quotes:expire` job without a second Railway service, keeping the one-service deployment shape                                        |
