...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * DejaVu Sans, not the dompdf default 'serif' (Times, a base-14 core
         * font with no embedded glyphs): Croatian diacritics (č, ć, ž, š, đ)
         * render as garbage on a non-embedded core font. `QuotePdfRenderer`
         * registers and embeds it explicitly from `resources/fonts/`.
         *
         * @var string
         */
